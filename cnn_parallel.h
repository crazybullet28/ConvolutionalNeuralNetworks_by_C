...
#ifndef PARALLEL_PROJ_CNN_PARALLEL_H
#define PARALLEL_PROJ_CNN_PARALLEL_H
...
//    float*** d; // local gradient
    ...
    int start;             // use for parallel pooling
} PoolLayer;
...
void cnn_setup(CNN* cnn, int inRow, int inCol, int outNum, int P, int myRank);
...
void pooling(PoolLayer* S, matrix** inMat, int I);
...
#endif //PARALLEL_PROJ_CNN_PARALLEL_H
